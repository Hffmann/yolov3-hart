...
from tracker.hart.model.alexnet import alexnet
from tracker.neurocity.component.model import Model
from tracker.neurocity.tensor_ops import convert_shape
from tracker.neurocity.component.layer import (ensure_square, Layer, AffineLayer, ConvLayer, DropoutLayer, LayerNormLayer,
...
class AlexNetModel(FeatureExtractor):
    ...
    def _build(self):
        ...
        o = alexnet(inpt, np.load("C:/Python/YOLO_HART_3D/tracker/checkpoints/bvlc_alexnet.npy", encoding = 'latin1').item(), self.layer, maxpool=self.upsample)
        self.orig_output = o
